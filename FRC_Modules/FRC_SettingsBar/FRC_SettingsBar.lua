...
FRC_SettingsBar.new = function(args)
	...
	for i=#options.buttons,1,-1 do
		...
		-- if there's an id supplied, make the button object directly addressable at the root of this menu object
		if options.buttons[i].id then
			menuGroup[options.buttons[i].id] = button;
		end
