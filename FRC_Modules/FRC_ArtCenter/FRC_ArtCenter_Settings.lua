...
settings.UI = {
	...
	SCENE_BACKGROUND_IMAGE = 'FRC_Assets/FRC_ArtCenter/Images/GENU_ArtCenter_global_Background_SkyWithClouds.png',
	...
	COLOR_PALETTE_LEFT_PADDING = 0,
	COLOR_PALETTE_BOTTOM_PADDING = 0,
	COLOR_PALETTE_SORTED = false,
	COLOR_WIDTH = 64,
	COLOR_HEIGHT = 64,
	COLOR_PADDING = 16,
	TEXTURE_WIDTH = 100,
...
settings.DATA = {
	...
	SAVE_PROMPT = 'Save Your Artwork',
	LOAD_PROMPT = 'Load Your Artwork',
